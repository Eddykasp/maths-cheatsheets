...
First visit the root, then traverse the left child and finally the right child.
\paragraph{In-order Traversal}
First traverse the left child, then visit the root and finally travers the right child.
